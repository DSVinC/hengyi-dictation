 ...
 *
 * v0.8.15 改动:
 * - 新增每日正确率追踪 (js/daily-stats.js)
 * - 艾宾浩斯间隔调整为 [1,1,2,3,5,12,20], R7=掌握
 * - 新增掌握词池,每天随机 3 个混入听写列表
 * - 新增统计页:SVG 趋势图 + 数据表格
 * - 结果页显示正确率 + 四档激励话术
 * - sync-to-github.mjs 排除 progress.json
 * - 修复 renderStatsPage DailyStats null 崩溃
 * - 23 文件变更,+2232/-122 行
 *
 * v0.8.4 改动:
 * - 修复 P2-5 XSS 防护不完整问题
